...
const About = () => (
  <section className="bg-slate-200 dark:bg-slate-900 py-20 px-6 max-w-4xl mx-auto text-center">
    ...
    <p className="text-slate-700 dark:text-slate-200 text-lg mb-12">Hi! I'm a Lead Software Engineer with 10+ years of full-stack development experience across enterprise SaaS platforms and agile teams. I have a proven track record in modernizing legacy systems, leading front-end and back-end development. I am adept at mentoring teams, optimizing system performance, and delivering secure, scalable solutions.</p>
