...
const About = () => (
  <section className="bg-slate-200 dark:bg-slate-900 py-20 px-6 max-w-4xl mx-auto text-center">
    ...
    <p className="text-slate-700 dark:text-slate-200 text-lg mb-12">Lead Software Engineer with 10+ years of full-stack development experience across enterprise SaaS platforms and agile teams. Proven track record in modernizing legacy systems, leading front-end and back-end development using industry standard tools. Adept at mentoring teams, optimizing system performance, and delivering secure, scalable solutions.</p>
